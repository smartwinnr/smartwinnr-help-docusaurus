...
/** localStorage slot for the wizard's autosaved state. Single source of
 *  truth: the wizard persists to it and the queue clears it (after delete/
 *  publish, and via "New article"). A version mismatch between the two
