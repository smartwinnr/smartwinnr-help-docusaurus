...
helpscout_url: https://help.smartwinnr.com/article/242-how-to-add-learning-sessions-in-smartpath
---
...
![](/img/learning/helpscout-image-87b452d7.jpg)
...
![](/img/learning/helpscout-image-2d051084.jpg)

The first half of the module is now created and to proceed further,  _Click_ on the '**Add Segment** _button_ at the _top right corner_ of the page.

![](/img/learning/helpscout-image-75db493e.jpg)

To create a segment that is basically the classroom/virtual session,  _choose_ the option- **Learning Session** in the '**Select Segment Type**' dropdown as shown below.

![](/img/learning/helpscout-image-91d0f8df.png)

After selecting the Learning Session,  _enter_ the 'Name' for the segment and you can select how many points the user will get after completing this segment under **Point Distribution>> On Completion** and click on the '**Create**' button. This will successfully create your segment for Learning Session. Refer to the below picture for reference.

![](/img/learning/helpscout-image-758c8031.jpg)
