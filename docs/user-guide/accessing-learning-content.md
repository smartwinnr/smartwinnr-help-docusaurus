---
title: "Accessing Learning Content"
description: "Complete guide for users on how to access and consume learning content in SmartWinnr"
slug: accessing-learning-content
sidebar_position: 4
---
...
**What You'll Find:**
- **Product Updates**: Latest information about products and services
- **Training Snippets**: Quick learning modules on specific topics
- **Best Practices**: Tips and techniques from industry experts
- **Company News**: Important announcements and updates
- **Interactive Content**: Polls, surveys, and engagement activities
...
**What You'll Find:**
- **Onboarding Programs**: Complete orientation for new employees
- **Skill Development**: Progressive competency building paths
- **Product Training**: Comprehensive product knowledge journeys
- **Compliance Training**: Required regulatory and policy training
- **Career Development**: Professional growth and advancement paths
...
- **Training Videos**: Recorded sessions and tutorials
- **Templates**: Forms, presentations, and working documents
...
5. Bookmark frequently used resources
...
**Feed Interface**
- **Main Feed**: Chronological list of content items
- **Categories**: Filter by topic or content type
- **Search**: Find specific topics or keywords
- **Favorites**: Access your saved content
- **Trending**: View popular content among peers
...
- **Module List**: All modules in the learning path
- **Time Estimates**: Expected completion time for each module
- **Prerequisites**: Requirements before starting certain modules
...
- **Plan Path Completion**: Set realistic timelines for SmartPaths
...
- **Apply Knowledge**: Try to use new information in your work
...
- **Optimize Settings**: Adjust playback speed for videos
- **Sync Across Devices**: Continue learning on different devices
- **Manage Storage**: Regularly clean up downloaded content

## Offline Learning

### ⬇️ **Downloading Content**
**What Can Be Downloaded:**
- Video content from SmartFeeds and SmartPaths
...
**Managing Downloads:**
- **View Downloaded**: Access saved content from menu
- **Clear Space**: Delete old downloads to free storage
- **Update Content**: Re-download for latest versions
...
- **Cross-Device**: Continue learning on different devices
- **Conflict Resolution**: App handles sync conflicts automatically
- **Progress Backup**: Regular backup of your learning data
...
**Completion Metrics**
- **SmartPath Progress**: How far you've advanced in learning journeys
- **Content Consumption**: Amount of content viewed over time
- **Quiz Performance**: Scores and improvement trends
- **Time Investment**: Hours spent learning each week/month

**Performance Insights**
- **Strengths**: Topics and areas where you excel
- **Improvement Areas**: Skills needing additional focus
...
- **Celebrate Achievements**: Recognize completed paths and goals
- **Plan Next Steps**: Identify future learning opportunities
- **Share Success**: Show achievements to your manager
...
**Missing Content**
- Verify content is assigned to you
...
- **Access Problems**: Contact your manager or administrator
- **Learning Support**: Reach out to your learning coordinator
...
- **Join Discussions**: Participate in comments and conversations
...
- **Seek Feedback**: Ask managers about your learning progress
- **Update Goals**: Adjust learning objectives as you grow
- **Stay Motivated**: Celebrate progress and achievements

Remember, learning content in SmartWinnr is designed to support your professional development. Make the most of these resources to enhance your skills, knowledge, and career growth!