...
Log in to SmartWinnr using your username and password.
...
**You Are Meeting**: Information about the person you'll be interacting with, including their name, role, background, and any relevant details about their practice or business.

**Session Objectives**: A numbered list of goals you need to accomplish during the conversation. Each objective shows a percentage indicating its importance in the evaluation (for example, "Professional Opening & Rapport Building - 17%").

**Competencies**: A list of selling skills that will be evaluated during this coaching, such as Opening, Objection Handling, Closing, and others.

**Time limit**: The expected duration of the coaching session is shown at the top (for example, "3-5 Min").

**Due date**: When the coaching assignment expires (for example, "Ends Dec 31").

Take a moment to review this information. Understanding the scenario, objectives, and competencies will help you prepare for a successful attempt.

### Step 6: Start the coaching
...
Once you complete the coaching session:

**Automatic evaluation**: The AI analyzes your recorded conversation and evaluates your performance against each objective and competency.

**Score generation**: You receive a score showing how well you performed. The AI evaluates criteria like objection handling, product knowledge, communication skills, and closing techniques.

**Feedback becomes available**: Detailed feedback is generated, including:

* Your overall score
* Performance ratings for each competency
* Strengths (what you did well)
* Improvement areas (specific recommendations for how to improve)

**You can review your feedback**: Return to the coaching card and click **View Feedback** to see your detailed results.

**You can retake the coaching**: If you want to improve your score or practice again, click **Try Again** to make another attempt. Most coaching assignments allow multiple attempts so you can learn and improve over time.
