...
**Distractors** enable you to include additional answer options that appear on the right-hand side. This feature is particularly useful when there are only a limited number of matching pairs and you want to increase the level of difficulty by requiring more careful selection from participants.

## How do the participants see the question?

Once the matching question is created and shared with participants, it will appear on their mobile application in an interactive format. The right-hand options are displayed as drop-down menus, which remain consistent across all items.
