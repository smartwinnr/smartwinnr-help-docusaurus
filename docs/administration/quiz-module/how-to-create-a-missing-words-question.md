...
Enter the option texts for each missing word and assign them to the appropriate answer option group. Since this example includes only one missing word, there will be a single answer option group (**Group 1**). If the question contains two missing words, corresponding answer option groups (**Group 1** and **Group 2**) should be created.
