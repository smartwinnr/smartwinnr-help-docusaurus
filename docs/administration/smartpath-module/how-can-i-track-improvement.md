...
Use the SmartPath Dashboard to:

* Monitor how many SmartPaths (learning courses) are currently active
* Track overall learner participation and engagement across all programs
* Measure total learning time and average time per learner
* View completion trends over time
* Understand the distribution of different learning components (quizzes, surveys, content, courses)
* Identify which SmartPaths have the highest completion rates
* Recognize top-performing learners
* Track certification program enrollment and completion
* Analyze performance by learning module type (quizzes, surveys, SmartFeeds)
* Make data-driven decisions about curriculum design and learner support
