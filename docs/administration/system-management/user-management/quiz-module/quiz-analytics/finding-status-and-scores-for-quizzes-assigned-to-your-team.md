...
1.Left Menu >> Quiz >> Click onÂ QuizzesÂ tab.
...
3\. This will open up the following page where you can see the completion status for each team member for the particular quiz.Â On the right - hand side, you can find the completion status for each member as - "Not Started", "Pending " or"Completed".You canÂalso find the scores obtained by the team members if they have already completed the quiz.

![](https://support.smartwinnr.com/api/v1/attachments/556)

4.To filter with the various completion status, click on the down-arrow at the top-right corner. This will give you the various filter options like -Â "All", "Not Started", "In Progress"Â and "Completed".
