...
1. In the **fourth step** of creating a competition, select **Scorecard** from the **“Select Task”** dropdown.
2. Enter a **name** for the scorecard task.
3. Select the **desired scorecard** that you want to add to the competition.
4. Set the **start and end dates** for the scorecard task.
