...
![](/img/helpscout/editors/how-do-i-give-access-permission-to-other-editors-1.png)

It will take you to the following page:

![](/img/helpscout/editors/how-do-i-give-access-permission-to-other-editors-2.png)

Here, select the Access Permission tab. It shows you the following page where you can add access permissions:

![](/img/helpscout/editors/how-do-i-give-access-permission-to-other-editors-3.png)
