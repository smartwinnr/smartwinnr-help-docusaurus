...
1\. Go to the left side menu, select the competitions under GAMIFICATION AND ENGAGEMENT
...
![](/img/competitions/helpscout-image-67893bf0.jpg)

Total Achieved: This column will show the data of your current progress.

Target: This column will show the target for the selected time duration (Monthly, Weekly, etc).

Score: This column will show the score, the user has achieved based on the score set for the KPI.

Target Achieved: This column will show your progress in comparison with the target. It will show the percentage of your target achieved.

Once you add the column, you can also change the Label by clicking on it.

![](/img/competitions/helpscout-image-0308cdb5.jpg)
