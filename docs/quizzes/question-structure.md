...
---
SmartWinnr supports various types of questions. But every question type has a standard structure. This is how any question will be structured:
...
You can add additional information about the topic in this section. The Feedback is visible to participants only after they have completed the quiz. This is helpful when you want to expand more on this question and provide background information. You can add an image, a video, or write the information.

4

## Categories

Categories form the building block in SmartWinnr. Every question is categorized. You can have multiple categories to define a question.