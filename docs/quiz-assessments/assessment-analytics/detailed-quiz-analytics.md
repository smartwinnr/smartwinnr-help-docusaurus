...
![](/img/quizzes/helpscout-image-e08e3884.png)
...
![](/img/quizzes/helpscout-image-e827f004.png)
...
![](/img/quizzes/helpscout-image-559f9af5.png)**Performance by Category by Country**
...
![](/img/quizzes/helpscout-image-a80d9bec.png)
...
![](/img/quizzes/helpscout-image-36000b6a.png)
...
The quizmaster or editor has access to details of an individuals performance. Click on the View Analytics button against each user in the leaderboard to find theÂindividualÂperformance.
...
* **Quiz Details**Â A high-level overview of the quiz.
* **Participants Report**Â A list of all the participants to whom the quiz had been assigned along with Quiz Completion Status, Quiz Taken date, Percentage Score, etc.
* **Participants Wise Question Analytics Reports**Â This report gives you data on every participant and how they have answered every question in the quiz.
* **Quiz Questions Details Reports**Â This report gives a list of questions that have been added to this quiz.
