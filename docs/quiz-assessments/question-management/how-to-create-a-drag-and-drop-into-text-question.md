...
helpscout_url: https://help.smartwinnr.com/article/281-how-to-create-a-drag-and-drop-into-text-question
---
In drag and drop into text questions, the participantsÂmust drag and drop text options from an answer bank into the question text.
...
3. ÂOn theÂ**'Create new Question'**Âselect theÂ**'Question Type'**ÂasÂ**Drag And Drop In Text**.

    ![](/img/quizzes/helpscout-image-45d95521.png)

4. Enter your question in theÂ**Question**Âfield. Here you first have to add the number of missing words that you want in the question.
