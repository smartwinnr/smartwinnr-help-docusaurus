---
id: 5fce03e7d580ce55a38b4d36
title: How can I login to SmartWinnr App?
description: >-
  Open the installed SmartWinnr app from your IOS or Android device. This is the
  icon of the app:
...
![Open the installed SmartWinnr app from your IOS or Android device. This is the icon of the app:](/img/helpscout/managers-and-team-members/how-can-i-login-to-smartwinnr-app-1.png)
...
![The app will open to show the login screen, similar to the screen below. Enter your username (it can be your company email or mobile number)](/img/helpscout/managers-and-team-members/how-can-i-login-to-smartwinnr-app-2.png)
...
If you see a message "user does not exist"-- it means that your SmartWinnr account has not been created by your system administrator. Please write to [support@smartwinnr.com](mailto:support@smartwinnr.com), mentioning your organization name and official email id.
...
![Upon clicking Next, it will display the field where the password has to be entered. Once you enter your password, click on the Sign In butto](/img/helpscout/managers-and-team-members/how-can-i-login-to-smartwinnr-app-3.png)
...
![Once you successfully login to the app, you will see the home screen of the SmartWinnr app. The home screen shows you a dashboard as shown i](/img/helpscout/managers-and-team-members/how-can-i-login-to-smartwinnr-app-4.png)
