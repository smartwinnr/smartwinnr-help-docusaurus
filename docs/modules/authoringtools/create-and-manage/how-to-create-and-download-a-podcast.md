---
id: create-and-download-a-podcast
title: "How to Create and Download a Podcast"
description: "This article shows you how to create and download a podcast using the Audio Lab feature."
slug: create-and-download-a-podcast
...
> **At a glance** - Create and download AI-generated podcasts in just a few steps using the Audio Lab feature.
...
- **Number of Episodes**: Specify between 2 to 10 episodes.
...
- **Gender**
- **Voice**
- **Participant Description**: Include expertise, job role, personality traits, and speaking style to enhance AI-generated conversations.
...
**Once the podcast has been successfully generated, additional management options are available from the top-right corner of the page.**

The following options are available:
![You can follow the below steps to select Create new audio in SmartWinnr.](/img/helpscout/authored/how-to-create-and-download-a-podcast-ms340jub.png)

### 1. Export SmartFeed

Click Export SmartFeed to export the generated podcast directly to SmartFeed.

This allows you to publish the podcast as a SmartFeed and assign it to learners through SmartPaths or other learning activities without manually uploading the audio again.

### 2. Export Transcript (PDF)

Select Export Transcript (PDF) to download the complete podcast transcript in PDF format.

### 3. Export Transcript (CSV)

Select Export Transcript (CSV) to download the podcast transcript in CSV format.

### 4. Archive

Select Archive to move the generated podcast to the Archive section.

Archived podcasts are removed from the active list while remaining available for future reference or retrieval whenever required.
