...
tags:
  - onboarding
---
 Users can post queries through both the SmartWinnr Mobile App and the SmartWinnr Web App (PWA).

**Steps**

**1. Log in:** Sign in to the SmartWinnr Mobile App or SmartWinnr Web App (PWA).

**2. Open QResolve:** Navigate to the QResolve section in left menu.
