...
tags:
  ...
  - gamification
---
Scorecards are a great way to measure your sales rep's performance against the KPIs that are set. After [Step 1 - Define KPIs](/modules/kpi-gamification/features/define-kpis) and [Step 2 - Create Field Mappings](/modules/kpi-gamification/create-and-manage/how-to-create-field-mapping), this is the 3rd step of the KPI Gamification process setup.
