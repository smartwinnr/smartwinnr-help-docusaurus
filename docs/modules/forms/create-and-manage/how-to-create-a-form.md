...
KPI Value Submit Form is a type of Form which is used to submit KPIs at multiple levels to evaluate their success at reaching targets. You can also select the Competition in which the data should be added. Once you add the competition, you will be able to display this form kpi data in the competition leaderboards.
...
**Allow Submissions By Manager:** It allows the managers to submit the form on behalf of their reportees

**Show After Expiry in User View:** It helps to show this form in the user view even after end date of the form has been passed.

**Show After Expiry in Manager View:** It helps to show this form in the manager view even after end date of the form has been passed.

**Allow Form Submission QR-Code:** Uses if the users want to scan and submit the form.

**Allow User to change status:** It allows the users to changes the status(Pending, Approved, Rejected) of the form.

**Enable Disclaimer:** It helps to add the disclaimer in the form. The users needs to respond to the disclaimer before start submitting the form.
...
This feature enables you to notify the users and approvers with comments or the status of their form submissions. 
...
Click on Advanced in the Form components. You get the following:
...
Blank: Select this if the user want to input the values by typing, selecting the dropdown values, selct and submit files etc.

Pre Populated: Select this if the system needs to select and display any profile details of the users.

Lookup Field: If the values needs to be taken from contact data uploaded to the system.
