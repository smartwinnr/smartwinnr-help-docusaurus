...
In SmartFeed, there are default size limits for media uploads to ensure optimal performance and faster loading. The maximum allowed file size for video uploads is **250 MB**, while the maximum allowed file size for image uploads is **2 MB**. Users are advised to ensure that their media files comply with these limits before uploading to avoid any upload or processing issues.
