...
1. You can resend a SmartFeed to your team as needed. Follow the steps below:
    ...
    2. Select the SmartFeed you want to send again.
    3. On the **View SmartFeed** page, click the **Send** button at the top-right corner.

        Choose the participants to whom you want to resend the SmartFeed.

        Select one of the following sending options:
...
* **Email IDs**: You can paste one or more specific email IDs comma seperated, in the email column to target only those users.
