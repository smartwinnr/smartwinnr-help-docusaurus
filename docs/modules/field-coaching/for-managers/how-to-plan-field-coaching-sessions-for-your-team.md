...
![Monthly freequncy](/img/helpscout/authored/authored-mtvgf16q.png)

### 4. Use the grace period
If your coach allows a grace period, you can still submit a previous session after the original window closes. For example, if the grace period is two days and you miss a monthly submission, you can submit that session during the first two days of the next month.

### 5. Add an ad hoc session
