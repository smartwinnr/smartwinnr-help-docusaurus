...
> **At a glance** - The Overview Analysis Tab provides insights into engagement metrics, performance trends, and skill improvements to help you evaluate the effectiveness of your AI coaching program.

The Overview Analysis Tab focuses on engagement metrics and session duration, providing a high-level summary of coaching activity, learner performance, skill improvement, and AI-generated insights.

## When to use this
Use the Overview Analysis Tab to:
- Monitor overall learner engagement with coaching.
- Track performance trends and identify skill improvement areas.
- Evaluate the effectiveness of your AI coaching program.
...
- The percentage change compared to the previous period (e.g., "+10% vs last quarter").

Use this metric to:
- Understand the overall number of learners engaging with coaching.
- Track changes in coaching participation over time.
- Identify increases or decreases in learner engagement.
...
- How frequently learners are practicing.
- Whether learners are making repeated attempts to improve their performance.
...
This metric helps trainers understand the potential efficiency gained by using AI coaching for practice and skill development.
...
The graph displays the progression from Attempt 1 through subsequent attempts, allowing trainers to see whether repeated practice results in improved scores.
...
### 3. Evaluate Skill Performance Improvement
The Skill Performance Improvement section shows the percentage improvement achieved across different skill groups. This displays individual skills along with their corresponding improvement percentages, helping to identify which specific skills are improving most effectively through practice.

![Skill Performance Improvement](/img/helpscout/authored/understanding-the-overview-analysis-tab-on-the-ai-coaching-dashboard-msx2cpah.png)
...
![Performance Trends](/img/helpscout/authored/understanding-the-overview-analysis-tab-on-the-ai-coaching-dashboard-msx4q3qb.png)
...
![Key Focus Areas](/img/helpscout/authored/understanding-the-overview-analysis-tab-on-the-ai-coaching-dashboard-msx4r0qc.png)
...
### 6. Assess Skills Development
The Skills Development section compares the learners' current skill levels against their target levels across multiple competencies, displayed using a visual radar chart.

![Skills Development](/img/helpscout/authored/understanding-the-overview-analysis-tab-on-the-ai-coaching-dashboard-msx4ovj2.png)
...
- These can be customized during the initial project setup to match your organization's standards.
...
### 7. Utilize AI Insights
The AI Insights panel provides intelligent, data-driven observations about learning patterns and opportunities.

![AI Insights](/img/helpscout/authored/understanding-the-overview-analysis-tab-on-the-ai-coaching-dashboard-msx4td6h.png)
