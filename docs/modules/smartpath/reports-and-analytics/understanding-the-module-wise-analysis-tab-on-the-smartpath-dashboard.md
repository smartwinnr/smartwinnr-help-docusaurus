...
> **At a glance** - The Module Wise Analysis tab provides detailed insights into quiz, survey, and SmartFeed performance across your SmartPaths.

The **Module Wise Analysis** tab breaks down performance by learning component type, giving you detailed insights into how each module category is performing.
...
![Quiz Module Analysis](/img/helpscout/editors/understanding-the-module-wise-analysis-tab-on-the-smartpath-dashboard-2.png)
...
![SmartFeed Module Analysis](/img/helpscout/editors/understanding-the-module-wise-analysis-tab-on-the-smartpath-dashboard-3.png)
...
SmartFeed consists of short-form learning content like knowledge articles, tips, updates, or bite-sized educational resources that learners can consume quickly.
...
* Unlike the AI Coaching Dashboard, you cannot filter by specific SmartPath names.
