...
## How the Editor can download various reports for SmartPath?
...
**Business Unit:** Select the business unit for which you want to generate the report. Choose **All** to include learners from all business units available in SmartPath batch.

**Country:** Filter learners based on their country/ subdivison.

**Meta Tag Type and Meta tags:** Select the type of meta tag (for example, Role, Designation, Region) used to further classify learners.

**User Status:** Filter reports for Active/Inactive users based on the requirement.

**Email:** Search for and generate the report for a specific learner using their email ID.

### Report Type

**Report Type:** Select the type of SmartPath report you want to download.

* Following are the type of reports available for SmartPath

* User-wise Report
* Segment-wise User Report
* Overview Report
* Evaluation and Feedback Report

_(Available options may vary based on configuration.)_

## Following is a detailed explanation on different reports available in SmartPath

### User-wise Report

The **SmartPath User Wise Report** provides **user-wise progress details** for all learners assigned to a SmartPath batch. This reports help to monitor individual learner progress and identify learners who need follow-ups.

For each learner, the report includes:

* Learner name and email
* Completion status (Started / Completed / Not Started) along with dates
* Number of segments completed vs total segments
* Percentage completion along with total time spend for the SmartPath

![](/img/helpscout/editors/how-to-download-smartpath-reports-2.png)

### SmartPath Overview Report
...
The Evaluation and Feedback Report captures qualitative and quantitative feedback collected through assignments, surveys, and evaluations. You will find multiple sheets available in this report which provides detailed evaluation on
