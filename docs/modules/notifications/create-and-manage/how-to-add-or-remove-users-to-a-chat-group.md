...
![](/img/helpscout/editors/how-to-add-or-remove-users-to-a-chat-group-1.png)

  Click on "**Group Members**" tab from here. Then, click on the "**Edit Members**" button.

![](/img/helpscout/editors/how-to-add-or-remove-users-to-a-chat-group-2.png)

It opens the following page:

![](/img/helpscout/editors/how-to-add-or-remove-users-to-a-chat-group-3.png)
