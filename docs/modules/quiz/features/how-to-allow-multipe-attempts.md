...
![](/img/helpscout/authored/how-to-allow-multipe-attempts-mr5xrtl0.png)

**How it works**

1. Enable Allow Multiple Attempts in Quiz Settings
Navigate to the quiz settings and toggle on **Allow Multiple Attempts**.

2. Configure attempt rules (when enabled, the following options appear):
