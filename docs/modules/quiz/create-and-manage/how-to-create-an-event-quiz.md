...
> **At a glance** - This article outlines the steps to create and manage an event quiz, including how to open and close it.

To create an event quiz, follow the steps below.

## When to use this
Use this guide when you need to create a quiz specifically for an event. This is useful for competitions or assessments tied to particular occasions.

## Steps

### 1. Navigate to the Competition Section
...
Once a quiz is closed, users who have already started it will be allowed to complete it. However, users who have not yet started will no longer be able to access or attempt the quiz.

### 4. View Leaderboards
Once the quiz is started, editors can view the leaderboards by clicking on the **Quiz TV** button.