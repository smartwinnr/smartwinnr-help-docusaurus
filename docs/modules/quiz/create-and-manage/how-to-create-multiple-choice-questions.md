...
## **Best Practices for Text Entry**

When copying text from external sources such as Microsoft Word, avoid pasting directly into the question editor because hidden formatting characters may cause display issues, especially on mobile devices. To prevent this:

* First paste the text into a plain text editor (e.g., Notepad) to strip hidden formatting,
* Then copy the sanitized text into the SmartWinnr question field.
...
You can also present questions using video-based content. Select videos related to products, product demonstrations, customer feedback, or customer success stories, and frame questions based on the video context.

To add a video, click the **Video** icon. You may upload your own video files or embed videos from supported platforms such as **YouTube, Box, and Brainshark**.
