---
id: 5fd4939923119734ee37edac
title: How can I duplicate a quiz?
description: >-
  You can duplicate an existing quiz. The quiz name, description, and questions
  in the quiz will get copied into the new quiz.
...
Ensure you have the necessary permissions to duplicate quizzes in your account.
...
![Select the quiz to duplicate](/img/helpscout/authored/how-can-i-duplicate-a-quiz-mr8uaw6j.png)
...
![Review and edit the new quiz settings](/img/helpscout/authored/how-can-i-duplicate-a-quiz-mr8uglgm.png)

### 3. Finalize Questions

Once the quiz is saved, you can check the questions and update them if required. You can also change the question sequence if needed. To check and add/remove questions from the duplicated quiz, go to step 2 and click on the **Edit Questions** button.

![Finalize questions in the duplicated quiz](/img/helpscout/authored/how-can-i-duplicate-a-quiz-mr8uks7b.png)
