---
id: check-user-time-per-question
title: "How to check user time taken per question in a quiz"
description: "Learn how to view the time each user took for every question in a quiz report."
slug: check-user-time-per-question
...
> **At a glance** - You can track the time each user took for every quiz question by reviewing the quiz report.
