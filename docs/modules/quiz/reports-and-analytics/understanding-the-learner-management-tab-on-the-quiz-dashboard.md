...
> **At a glance** - The Learner Management tab provides insights into individual learners, categorizing users by performance and risk level.
...
* Identify high performers and recognize their contributions.
* Monitor at-risk users who may need additional support.
* Stay on top of upcoming certification deadlines.
...
* The main number (e.g., 19) indicates new users added.
...
* The main number (e.g., 0) indicates high performers.
...
* The main number (e.g., 5) indicates at-risk learners.
...
* The main number (e.g., 0) indicates upcoming certifications.
...
* If the at-risk segment is large, launch targeted training programs.
* If the high performer segment is small, review if content is too difficult.
...
![Learner Management Tab](/img/helpscout/editors/understanding-the-learner-management-tab-on-the-quiz-dashboard-1.png)
