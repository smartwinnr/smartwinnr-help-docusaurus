...
> **At a glance** - The Performance tab on the Quiz Dashboard provides insights into quiz scores, pass/fail rates, and score distribution patterns, helping you evaluate learner performance effectively.

The **Performance Tab** provides detailed analysis of quiz scores, pass/fail rates, and score distribution patterns.
...
* If 95% of attempts are in the 0-50% range (as shown in the example), this indicates urgent training intervention is needed.
...
**Example interpretation:** If the "North" zone shows 50%, 60%, 34%, 39% across four months, that zone needs targeted support and is not showing improvement over time.

![Performance Tab](/img/helpscout/editors/understanding-the-performance-tab-on-the-quiz-dashboard-1.png)
