...
> **At a glance** - The Overview Tab on the Quiz Dashboard provides essential metrics and insights into quiz activity, performance, and engagement.

The Overview Tab offers a high-level snapshot of quiz activity, performance, and engagement. It contains key metrics that summarize quiz performance, a quiz performance trend chart, popular quizzes, and recent activity.

## Key Metrics Section

This section displays four core metrics that summarize quiz performance.

![Key Metrics Section](/img/helpscout/authored/understanding-the-overview-tab-on-the-quiz-dashboard-mrsuremb.png)
...
![Quiz Performance Trend](/img/helpscout/authored/understanding-the-overview-tab-on-the-quiz-dashboard-mrsuv38s.png)
...
* Quiz name (e.g., "Onboarding," "pick up quiz").
* Number of attempts.
* Average score.
* Pass rate.
...
![Recent Activity](/img/helpscout/editors/understanding-the-overview-tab-on-the-quiz-dashboard-2.png)
