...
![](/img/helpscout/editors/detailed-quiz-analytics-1.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-2.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-5.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-6.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-7.png)**Performance by Category by Country**
...
![](/img/helpscout/editors/detailed-quiz-analytics-8.png)

If you want to see further details, by different Territories, etc, click on the ‘View Details’ button.

![](/img/helpscout/editors/detailed-quiz-analytics-9.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-10.png)

It will open the following pop-up where you can see

* The question,
* The correct option to the question
* And the graph shows all the options of the question and analytics of the number of responses each option has received.![](/img/helpscout/editors/detailed-quiz-analytics-11.png)
    ...
    ![](/img/helpscout/editors/detailed-quiz-analytics-12.png)Here, enter the hex code of the colour of your choice and click on the "Apply" button. This will change the colour of the graph successfully.
...
![](/img/helpscout/editors/detailed-quiz-analytics-13.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-14.png)
...
![](/img/helpscout/editors/detailed-quiz-analytics-15.png)The excel will have the following sheets:
