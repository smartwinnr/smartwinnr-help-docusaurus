...
Sales TV is used to display information to everyone on a screen. It comes up in the format of slides which changes with the time interval you set it.

You can create the slides based on your requirements and below are the steps on how to do it.

Go to EDITOR>>Settings>>Sales TV. Click on the create icon on the top right corner.

![](/img/reports/helpscout-image-38c7d7fc.jpg)
...
![](/img/reports/helpscout-image-07b90286.jpg)
