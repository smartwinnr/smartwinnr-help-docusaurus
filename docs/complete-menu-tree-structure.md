...
This document provides the exhaustive listing of all files and directories in the SmartWinnr documentation, organized according to the current sidebar structure as defined in `sidebars.ts`.
...
Core onboarding and account management documentation covering user setup, authentication, profile management, and basic app navigation.
...
- Media integration (images, videos, audio, links)
- Question editing, bulk upload, and response management
...
- Challenge creation (individual, group, manager)
...
- Streaming and sharing capabilities
...
- Chat groups and communication tools
- Contact management and divisions
- Audit logging and resource tracking
- Q&A and query resolution systems
- Form administration and approvals
...
## **Legacy Directories** *(Not in active sidebar)* - 33 files
...
- `AUTOMATED_IMAGE_GENERATION.md` - Technical documentation
- `menu-tree-structure.md` - Navigation overview
- `complete-menu-tree-structure.md` - This document

---

## **Summary Statistics**

| Section | Files | Status | Development Level |
|---------|-------|--------|-------------------|
| **Getting Started** | 27 | ✅ Complete | Well-developed |
| **Quiz & Assessments** | 51 | ✅ Complete | Comprehensive |
| **MicroLearning & SmartFeeds** | 19 | ✅ Complete | Well-developed |
| **Learning & SmartPaths** | 13 | ✅ Complete | Moderate |
| **Forms & Data Collection** | 14 | ✅ Complete | Well-developed |
| **Knowledge Hub** | 8 | ✅ Complete | Moderate |
| **Surveys & Feedback** | 11 | ✅ Complete | Well-developed |
| **Analytics & Reporting** | 1 | ⚠️ Underdeveloped | Needs content |
| **Competitions & Gamification** | 34 | ✅ Complete | Comprehensive |
| **Coaching & Performance** | 19 | ✅ Complete | Well-developed |
| **Administration** | 35 | ✅ Complete | Comprehensive |
| **Mobile & Platform Tools** | 1 | ⚠️ Underdeveloped | Needs content |
| **Help & Support** | 2 | ⚠️ Minimal | Needs expansion |
| **Legacy Content** | 33 | 🔄 Needs review | Mixed |
...
- **Getting Started** is the only section expanded by default (`collapsed: false`)
- All other main sections are collapsed by default (`collapsed: true`)
- The sidebar uses `type: 'autogenerated'` which automatically builds navigation from directory structure
- Directory-based organization enables automatic menu generation
- Empty subdirectories create structure for future content expansion

---

*This document reflects the current state as of August 2025. Structure may evolve as content is added or reorganized.*
