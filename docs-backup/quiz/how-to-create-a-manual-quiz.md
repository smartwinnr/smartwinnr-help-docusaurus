...
*   **Enable Timer?** – Check this option if you want this quiz to be timed. Enter the number of minutes within which the quiz takers will have to complete the quiz. Check the 'Show Time' option if you would like to show the time taken by each quiz taker in the quiz leaderboard.![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5ffc335f66df373cab707fe5/file-8gw5xVz7hk.png)
...
*   **Show Quiz Review**–  Check this option if you would like to show the correct options and feedbacks provided for the questions in the quiz. Quiz takers can view the review answers options once they successfully complete the quiz. By default, the 'Show Quiz Review' option is checked for each quiz. SmartWinnr allows you to lock/unlock the review option for a quiz at any time if the quiz was created with a review option. To lock the review for an existing quiz, go to Editor > Questions and Quizzes > View All Quizzes > Select the quiz > Lock Review.  [![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5ffc652166df373cab708121/file-4OZXikL4en.png)](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5ffc652166df373cab708121/file-4OZXikL4en.png)
*   **Randomly Assign Questions** – This option allows you to assign a random set of questions to each participant in the quiz. If you check this option, the system will ask for the Number of Questions per Quiz. For example, if the Number of Questions per Quiz is set to 10 and you have 30 questions added to the quiz, the system will automatically send 10 random questions out of the 30 questions to each participant. [![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5ffc663766df373cab708123/file-IlqCvP2diA.png)](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5ffc663766df373cab708123/file-IlqCvP2diA.png) If you choose the Randomize Question by tag option, this will allow you to customize the number of questions from each tag.
*   **Question skip in Quiz** – Check this option if you want to allow quiz takers to skip questions in this quiz.![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/60014baecfe30d219ccd8163/file-HtdG7CVxUC.png)   
...
*   **Custom Email Subject** – This option allows you to set a custom email subject for the email notification that is sent to the quiz takers. If you check this option, the system will ask for the message to be delivered to the users. By default, the email subject is 'New quiz assigned'.![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/60014cd0c64fe14d0e1fb34d/file-WphMliOIyD.png)
*   **Custom Message on Completion** – This option allows you to edit the pop-up message that the quiz taker will see on completing the quiz. If you check this option, the system will ask for a custom message that the participants will see on completing the quiz. By default, it will display a message 'You have successfully completed this quiz'.![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/60014d5a1c64ad47e4b6f90c/file-xNSW4cwkDy.png)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/5fcc5d22d580ce55a38b4a61/images/5fd491c43d1d2a5b1c5ea156/file-isI55gzjOn.png)