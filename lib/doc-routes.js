 ...
 *  top-level section landings from nav-sections.ts, and the homepage.
 *  The homepage is /home, NOT / - bare / is a public 301 to the marketing
 *  site (root handler in server.js) and is not a route in the build, so a
 *  redirect targeting it would pass pre-flight here and then hard-fail the
 *  production build in plugin-client-redirects.
