...
| **Typography / fonts** | 🟡 in flight | `src/css/custom.css` has Inter / Space Grotesk / JetBrains Mono stack + purple palette; full audit (heading scales, code blocks, per-component overrides) still pending |
